...
@section('content')
 ...
 <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="m-t-0 header-title"><b>Services List</b></h4>
                            ...
                            <tbody>
                                @foreach ($services as $service)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('service.show',$service->id) }}">{{ Str::limit($service->service_title, 45, $end='...') }}</a>
                                        </td>
...
@section('footer_script')
    <script>
        function blogDelete(){
            alert('Are you shure ? You want to delete this Service !')
        }
    </script>
@endsection
